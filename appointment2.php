...
if(isset($_POST["submitbtn"])){
    ...
    // if($Email = $Email)
    //     {
    // //     $query = "INSERT INTO appointment2 VALUES ('', '$fullname','$Email','$time','$address','$date',$phnumber)";
    ...
    // }
        ...
        $uploads_dir = 'C:\Users\Shaikh Arfan\Downloads\Virtual D\Virtual Darzee\images';
    
        #TO move the uploaded file to specific location
        move_uploaded_file($tname, $uploads_dir.'/'.$pname);
     
        #sql query to insert into database
        $query = "INSERT into appointment2 VALUES('', '$fullname','$Email','$time','$address','$date',$phnumber,'$title','$pname')";
...
<body class="main_bg">
    ...
    <div class="form">
        <div class="form-text">
            <h1><span>Book an Appointment No</span></h1>
    ...
    <input type="submit" name="submitbtn">
                ...
                <!-- <div id="submit">
                  ...
                  <a href="customize.html" class="jump">Jump To Previous Page</a>
